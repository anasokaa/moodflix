...
export const translations = {
  en: {
    welcome: {
      ...
      features: {
        express: "Show us your beautiful face! 📸",
        picks: "Get movies that match your mood 🎯",
        discover: "Find hidden cinematic gems 💎"
      },
      start: "Let's Roll! 🎬"
    },
    loading: {
      analyzing: "Reading your vibes... 🔮",
      regenerating: "Mixing up some fresh movie magic! ✨"
    },
    movies: {
      title: "Your Movie Matches! 🍿",
      subtitle: "Based on your current mood",
      generateMore: "More Movie Magic! ✨",
      watchOn: "Watch on",
      matchReason: "Why this movie?",
      noMovies: "Oops! Let's try that again with a clearer shot! 📸",
      error: "Movie magic hiccup! Let's try again! 🎬"
    },
    emotions: {
      anger: "Fired Up",
      disgust: "Not Impressed",
      fear: "Spooked",
      happiness: "Joyful",
      neutral: "Chilled",
      sadness: "Blue",
